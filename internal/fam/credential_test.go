...
func TestForgeHostFromURL(t *testing.T) {
	cases := map[string]string{
		...
		"https://gitea.home.rlupi.com:3000/": "gitea.home.rlupi.com:3000",
...
// forge_url is gitea.home.rlupi.com:3000 (matching sampleFamTOML).
