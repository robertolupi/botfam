...
# companion script (doc/user/PROTOCOL.md): merge-only, refuses to run in the
...
case "$git_dir" in
  ...
  *) die "this is the shared main checkout — never sync here (see doc/user/PROTOCOL.md). cd into your own worktree." ;;
esac
